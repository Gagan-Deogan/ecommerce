        ...
        <li className="row card row typ-vrt bor-sol cart-card w12">
            ...
            <div className="column card-title eight">
                ...
                <div className="row align-center margin-t-16 margin-b-16" >
                    ...
                    <button className="btn-link margin-l-8" onClick={ ()=>{ 
                        handleQuantityChange( "DECREMENT_QUANTITY", product.id )
                    }} >
                        <img src={removeIcon} alt=""/>
                    </button>
                    <button className="btn-link margin-r-8" onClick={()=> handleQuantityChange( "INCREMENT_QUANTITY", product.id ) } > 
                        <img src={addIcon} alt=""/>
                    </button>
                </div>
                <div className="row margin-t-16" >
                    ...
                    { !product.inWish && <button className="sm-btn-pry margin-l-8" onClick={ ()=>handleSaveForLater(product) }  >
                            Save for later
                        </button>}
                </div>
            </div>
